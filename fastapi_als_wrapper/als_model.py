...
#         scores = [review.score for review in reviews if review.score > 0 else 0]
...
#             # Get items the user has already interacted positively with (from training data)
...
#                 .all()
#             )
#             user_positively_interacted_items = [item.course_id for item in user_positively_interacted_items]
            
#             # Get items the user has already interacted negatively with (from training data)
